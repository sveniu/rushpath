...
func (s *Service) WSStrongauthGetRecoveryKeys(
	...
	*WSStrongauthGetRecoveryKeysOutput,
	...
	req, err := http.NewRequest(
		"POST",
		"https://ws1.dashlane.com/3/strongauth/getRecoveryKeys",
	...
	// Decode the response.
	wsStrongauthGetRecoveryKeysOutput := &WSStrongauthGetRecoveryKeysOutput{}
	...
	return wsStrongauthGetRecoveryKeysOutput, nil
}
